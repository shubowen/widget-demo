    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                Log.i(TAG, "ACTION_DOWN: " + state2Str(mDragState));
                break;
            }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    Log.i(TAG, "ACTION_MOVE-0: " + state2Str(mDragState));
                    ...
                    Log.i(TAG, "ACTION_MOVE-1: " + state2Str(mDragState));
                    Log.i(TAG, "ACTION_MOVE--1-pastSlop: " + pastSlop);

                    if (pastSlop && tryCaptureViewForDrag(toCapture, pointerId)) {
                        break;
                    }
                }
                Log.i(TAG, "ACTION_MOVE: " + state2Str(mDragState));
                saveLastMotion(ev);
                break;
            }
